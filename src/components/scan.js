...
const Scan = ({navigation}) => {
    ...
    return (
        <View style={{backgroundColor:"skyblue",height:"100%",flexDirection:"column"}}>
                <View style={{backgroundColor:"#0890B6",height:"7%"}}>
    ...
    />
    <Text style={{left:"24%",top:"22%"}}>Exclude songs less than 60 seconds.</Text>
    <CheckBox 
    containerStyle={{marginLeft:0,width:"100%",left:"10%",top:"21.9%"}}
    checked={newValue}
    onPress={()=>setNewValue(!newValue)}
    />
    <Text style={{left:"24%",top:"17%",  textDecorationLine: 'underline',}}>Exclude songs less than 50Kb</Text>
    <CheckBox 
    ...
    <TouchableOpacity style={{borderWidth:2,borderColor:"#fff",width:"78%",top:"30%",marginLeft:"12%",paddingLeft:"10%",borderRadius:20,height:"7%",paddingTop:"3.5%"}}onPress={()=>navigation.navigate('Library')}><Text style={{left:"28%",top:"10%"}}>Start scan</Text></TouchableOpacity>
       </View>
    );
}
