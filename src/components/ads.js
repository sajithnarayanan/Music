    ...
    return (
        ...
        <AntDesign name="arrowleft" size={25} style={{left:10,top:15}} onPress={()=>navigation.goBack()} />        
            ...
            <Text style={{fontWeight:"bold",top:20,left:10}}>Recomended</Text>
                ...
                <Text style={{left:120,top:-27,fontSize:12,fontStyle:"italic"}}>HD Camera</Text>
                <Image source={require('../assets/ads/4.png')} style={{height:60,width:50,borderRadius:25,top:-105,left:220}} />
                <Text style={{left:200,top:-102,fontSize:12}}>Photo Slideshow</Text>
                ...
                <Text style={{left:117,top:-160,fontSize:12}}>Music Player</Text>
            ...
            <View style={{height:395,backgroundColor:"#fff",borderRadius:25,marginLeft:25,top:11,width:"80%"}}>
