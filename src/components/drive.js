...
const Drive = ({navigation}) => {
    return (
        ...
        <TouchableOpacity style={{borderWidth:2,borderColor:"#fff",width:"20%",paddingLeft:10,left:"20%",top:"40%"}}><Text>Cancel</Text></TouchableOpacity>
        <TouchableOpacity style={{borderWidth:2,borderColor:"#fff",width:"20%",paddingLeft:20,left:"50%",top:"37.5%",backgroundColor:"skyblue"}}onPress={()=>navigation.navigate('Library')}><Text>OK</Text></TouchableOpacity>
        </View>
    );
}
