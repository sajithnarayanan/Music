...
const Drive = ({navigation}) => {
    return (
        ...
        <TouchableOpacity style={{borderWidth:2,borderColor:"#fff",width:"20%",paddingLeft:20,left:"50%",top:"37.2%",backgroundColor:"skyblue"}}onPress={()=>navigation.navigate('Library')}><Text>OK</Text></TouchableOpacity>
        </View>
    );
}
