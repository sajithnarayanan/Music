...
const Folder = ({navigation}) => {
    return (
        <View style={styles.container}>
            ...
            <Icon1 name="dots-three-vertical" size={20} style={{left:"90%",top:-15}} />
            ...
            <Icon1 name="dots-three-vertical" size={20} style={{left:"90%",top:-50}} />
            <Icon name="folder-open" size={35} style={{top:-15,left:"3%"}} onPress={()=>navigation.navigate('Audio')}/>
            <Text style={{left:"20%",top:-42}}>My favorite</Text>
            <Text style={{left:"75%",top:-55}}>10 song</Text>
            <Icon1 name="dots-three-vertical" size={20} style={{left:"90%",top:-80}} />
            <Icon name="folder-open" size={35} style={{top:"",left:"3%"}} onPress={()=>navigation.navigate('Whatsapp')}/>
            <Text style={{left:"20%",top:-67}}>Whatsapp Audio</Text>
            <Text style={{left:"75%",top:-85}}>10 song</Text>
            <Icon1 name="dots-three-vertical" size={20} style={{left:"90%",top:-110}} />
            </View>
        </View>
